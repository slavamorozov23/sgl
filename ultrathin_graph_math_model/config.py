...
DIM_FEEDFORWARD = 4864  # FFN hidden size ≈2.5×d_model for extra-small model
DROPOUT = 0.1
MAX_SEQ_LEN = 128  # reduced for speed
MIN_PATH_LENGTH_RATIO = 0.3
MLA_D_C = 512  # Dimension of latent space for KV compression in MLA
MLA_QUERY_D_C = 1536  # Dimension of latent space for query compression (d'_c)
...
LOAD_BALANCING_LOSS_WEIGHT = 0.0  # Start with small value, e.g. 0.01 or 0.001
